...
//       Метод run должен считывать слова из reader и добавлять их в список result.
//       Метод run должен после каждого считывания увеличивать счетчик прочитанных строк countReadStrings на 1.